...
namespace WindowsFormsApp3 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string Position, string Phone, string Address) {
...
namespace WindowsFormsApp3.Database1DataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Position], [Phone], [Address]) VALUES (@Na" +
                "me, @Position, @Phone, @Address);\r\nSELECT Id, Name, Position, Phone, Address FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Position] = @Position, [Phone] = @Phone, [Address] = @Address WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT Id, Name, Position, Phone, Address FROM Employee WHERE (Id = @Id)";
        ...
        public virtual int Insert(string Name, string Position, string Phone, string Address) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Position, string Phone, string Address, int Original_Id, string Original_Name, string Original_Position, string Original_Phone, string Original_Address, int Id) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Position, string Phone, string Address, int Original_Id, string Original_Name, string Original_Position, string Original_Phone, string Original_Address) {
            return this.Update(Name, Position, Phone, Address, Original_Id, Original_Name, Original_Position, Original_Phone, Original_Address, Original_Id);
        }
    }
